...
alias hsi='heroku pg:psql --remote integration'
...
#eclipse
export PATH=$PATH:/home/pri/eclipse/cpp-mars/eclipse:

#me specific
setxkbmap -option ctrl:swapcaps
alias ps='ps -aef'
alias codethesis='cd /home/pri/ndnSIM/ns-3'

#NVIDIA specific
export AS2REMOTE=1
export PATH=$PATH:/home/tools/repodir:/home/nv/bin/
export PATH=$PATH:/home/tools/perforce/helix_client/bin:/home/tools/perforce#
export PATH=$PATH:/home/tools/perforce/helix_client/bin:/home/tools/perforce/helix_server
export P4ROOT=/home/pri/Perforce/pvakayil_ws #the path to the directory when you want#
export P4PORT=p4sw:2006 #host:port of the Perforce repository to sync
export P4CLIENT=pvakayil_ws #an arbitrary, globally-unique identifier for yo#
export P4USER=pvakayil

alias head='cd /home/repows/chips_a'
alias codedma='cd /home/pri/Perforce/pvakayil_ws/sw/dev/gpu_drv/chips_a/diag/mods/tegra/dev'
alias codefreq='cd /home/pri/Perforce/pvakayil_ws/sw/dev/gpu_drv/chips_a/diag/mods/tegra/js'
alias training='cd /home/pri/Training/'
alias mountnetapp='sudo mount -t cifs //netapp-hq/quickturn /mnt/netapp-hq/quickturn -o username=pvakayil,rw'


BUILD_CFG=release
BUILD_ARCH=aarch64
BUILD_OS=android
BUILD_OS_SUBTYPE=linux
MODS_RUNSPACE=/tmp/
...
#ns3
alias ns3='cd /home/pri/ndnSIM/ns-3'
alias thesis='cd /home/pri/ndnSIM/ns-3'
...
export OPENGROK_INSTANCE_BASE=/home/pri/opengrok/

export BUILD_CFG=release
export BUILD_ARCH=aarch64
export BUILD_OS=android
export BUILD_OS_SUBTYPE=linux​
export INCLUDE_GPU=false

alias opengrok='cd /software/nvidia_opengrok/opengrok'
